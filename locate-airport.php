...
<html>
<head>
<meta http-equiv="refresh" content="15;url=http://www.flynor.net/?airport=BGO" />
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js"></script>
<script type="text/javascript" src="http://code.google.com/apis/gears/gears_init.js"></script>
<script type='text/javascript'>
<!--
function refreshPosition(position) {
	location.replace("http://www.flynor.net/locate-airport.php?gps=0&gpsdata_latitude=" + position.coords.latitude + "&gpsdata_longitude=" + position.coords.longitude + "");
}
function handleError(positionError) {
	location.replace("http://www.flynor.net/?airport=BGO");
}
$(document).ready(function() {
	...
	if (window.navgeo) {
		...
		$('div#debug').append('FlyNor is asking you about permission for location sharing (HTML5).  (Otherwise redirecting in 15 seconds with departure from BGO/Bergen.)');
	} else {
		...
		if (window.gears) {
			...
			$('div#debug').append('FlyNor is asking you about permission for location sharing (Google Gears).  (Otherwise redirecting in 15 seconds with departure from BGO/Bergen.)');
